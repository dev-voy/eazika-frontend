...
//               {activeTab === "Description" && (
//                 <p>
//                   A delicious and fresh {product.name.toLowerCase()}, perfect
//                   for a healthy lifestyle. Enjoy the rich flavors and nutrients
//                   packed in this high-quality product.
//                 </p>
//               )}
//               {activeTab === "Review" && <p>Reviews will be shown here.</p>}
//               {activeTab === "Discussion" && (
//                 <p>Discussion content will appear here.</p>
//               )}
//             </div>
