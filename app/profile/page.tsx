    ...
    <MainLayout>
      <div className="w-full max-w-5xl mx-auto bg-gray-50 min-h-screen">
        <main className="flex-grow overflow-y-auto p-4 md:p-6 space-y-6">
          ...
          >
            <button className="w-full flex items-center justify-center p-4 text-red-600 font-semibold bg-white rounded-2xl shadow-sm border border-gray-100 hover:bg-red-50 transition-colors">
