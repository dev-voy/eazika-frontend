...
import { ArrowLeft, Bike,ClipboardList } from 'lucide-react';
            ...
            <main className="flex-grow overflow-y-auto p-4">
                 <form className="space-y-4">
                    <div>
                        ...
                        <select className="mt-1 block w-full bg-white border border-gray-300 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400">
                            <option>Motorcycle</option>
                            <option>Car</option>
                        </select>
                    </div>
                    <InputField icon={Bike} label="Vehicle Model" name="model" defaultValue="Honda Activa" />
                    <InputField icon={ClipboardList} label="License Plate" name="license" defaultValue="PB 10 XY 1234" />
                     <div className="pt-4">
