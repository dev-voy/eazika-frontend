...
import DeliveryBottomNav from "@/app/components/DeliveryBottomNav";
import DeliverySidebar from "@/app/components/DeliverySidebar";
    ...
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <div className="md:ml-64">
        <div className="w-full max-w-md mx-auto md:max-w-none md:mx-0 bg-gray-50 flex flex-col min-h-screen relative">
          ...
          <div className="flex-grow pb-20 md:pb-6">{children}</div>
          ...
          {isGpsOff && (
            <div className="absolute inset-0 bg-black/80 z-50 flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="text-gray-300 mt-2">
                Please enable your location services to continue using the app.
              </p>
              <button
                onClick={() => setIsGpsOff(false)}
                className="mt-6 px-6 py-3 bg-orange-500 text-white font-semibold rounded-full"
              >
                Retry
              </button>
            </div>
